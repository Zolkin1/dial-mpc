...
@dataclass
class UnitreeH1StairsEnvConfig(BaseEnvConfig):
...
class UnitreeH1StairsEnv(BaseEnv):
    def __init__(self, config: UnitreeH1StairsEnvConfig):
    ...
    def make_system(self, config: UnitreeH1StairsEnvConfig) -> System:
        model_path = get_model_path("unitree_h1", "mjx_scene_h1_stairs.xml")
...
brax_envs.register_environment("unitree_h1_stairs", UnitreeH1StairsEnv)
dial_envs.register_config("unitree_h1_stairs", UnitreeH1StairsEnvConfig)