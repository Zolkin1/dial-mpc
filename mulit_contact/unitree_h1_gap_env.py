...
@dataclass
class UnitreeH1GapEnvConfig(BaseEnvConfig):
...
class UnitreeH1GapEnv(BaseEnv):
    def __init__(self, config: UnitreeH1GapEnvConfig):
    ...
    def make_system(self, config: UnitreeH1GapEnvConfig) -> System:
        model_path = get_model_path("unitree_h1", "mjx_scene_h1_gap.xml")
...
brax_envs.register_environment("unitree_h1_gap", UnitreeH1GapEnv)
dial_envs.register_config("unitree_h1_gap", UnitreeH1GapEnvConfig)